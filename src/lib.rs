...
#[derive(Debug)]
pub struct ConfigCenterProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ConfigCenterProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ConfigCenter processing");
    
    let mut processor = ConfigCenterProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ConfigCenterProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ConfigCenterProcessor::new(false);
